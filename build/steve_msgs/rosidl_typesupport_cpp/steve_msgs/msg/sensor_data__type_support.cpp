...
static const _SensorData_type_support_symbol_names_t _SensorData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, steve_msgs, msg, SensorData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, steve_msgs, msg, SensorData)),
  }
};
...
{
  return &::steve_msgs::msg::rosidl_typesupport_cpp::SensorData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, steve_msgs, msg, SensorData)() {
  return get_message_type_support_handle<steve_msgs::msg::SensorData>();
}
