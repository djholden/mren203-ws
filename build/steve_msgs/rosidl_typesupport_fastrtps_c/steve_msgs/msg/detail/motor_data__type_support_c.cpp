...
#include "steve_msgs/msg/detail/motor_data__rosidl_typesupport_fastrtps_c.h"
...
using _MotorData__ros_msg_type = steve_msgs__msg__MotorData;
...
size_t get_serialized_size_steve_msgs__msg__MotorData(
  const void * untyped_ros_message,
...
static uint32_t _MotorData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_steve_msgs__msg__MotorData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_steve_msgs
size_t max_serialized_size_steve_msgs__msg__MotorData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = steve_msgs__msg__MotorData;
    is_plain =
      (
...
static size_t _MotorData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_steve_msgs__msg__MotorData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, steve_msgs, msg, MotorData)() {
